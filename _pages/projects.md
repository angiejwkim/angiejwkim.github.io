...
### Honors Thesis
As an honors candidate, I'm working on a senior thesis with Professor [Stephen Bach](http://stephenbach.net/). The project is still in its early stages, but I'm looking into how to increase model accuracy in weakly supervised settings. I'm looking forward to having ownership over a research project and seeing it through to completion!
